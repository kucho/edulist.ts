...
function setBorder(ws: Excel.Worksheet, width: number, r: number, c: number) {
...
function writeCapList(
    ...
    const logo = wb.addImage({
        buffer: fs.readFileSync("./assets/logo.png"),
        extension: "png",
    });
